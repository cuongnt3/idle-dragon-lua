--- hero_40002_eff_attack
--- @class Hero40002EffAttackConfig
Hero40002EffAttackConfig = Class(Hero40002EffAttackConfig)

--- @return void
--- @param transform UnityEngine_Transform
function Hero40002EffAttackConfig:Ctor(transform)
...
return Hero40002EffAttackConfig
