--- hero_20020_eff_skill
--- @class Hero20020EffSkillConfig
Hero20020EffSkillConfig = Class(Hero20020EffSkillConfig)

--- @return void
--- @param transform UnityEngine_Transform
function Hero20020EffSkillConfig:Ctor(transform)
...
return Hero20020EffSkillConfig
