...
local function shaBinary256 (msg)
    msg = pad64(msg, #msg)
...
local function shaBinary512 (msg)
    msg = pad128(msg, #msg)
    local h1, h2, h3, h4, h5, h6, h7, h8 =
...
--- @return string hexa
--- @param msg string
local function shaHex512 (msg)
   return stx(shaBinary512(msg))
end

--- @return string hexa
--- @param msg string
local function shaHex256 (msg)
    return stx(shaBinary256(msg))
end
------------------------------------------------------------------------

SHA2 = {
    shaBinary256 = shaBinary256,
    shaBinary512 = shaBinary512,
    shaHex256 = shaHex256,
    shaHex512 = shaHex512,
}
