--- @class UIVictoryGuildWarLayoutConfig
UIVictoryGuildWarLayoutConfig = Class(UIVictoryGuildWarLayoutConfig)

--- @return void
--- @param transform UnityEngine_Transform
function UIVictoryGuildWarLayoutConfig:Ctor(transform)
