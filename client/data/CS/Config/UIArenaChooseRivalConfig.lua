--- @class UIArenaChooseRivalConfig
UIArenaChooseRivalConfig = Class(UIArenaChooseRivalConfig)

--- @return void
--- @param transform UnityEngine_Transform
function UIArenaChooseRivalConfig:Ctor(transform)
	...
	--- @type UnityEngine_UI_Button
	self.buttonRefresh = self.transform:Find("popup/refresh_button/bg_button_flat_1"):GetComponent(ComponentName.UnityEngine_UI_Button)
	--- @type UnityEngine_UI_Button
	...
	--- @type UnityEngine_UI_Text
	self.localizeRefresh = self.transform:Find("popup/refresh_button/bg_button_flat_1/text_refresh"):GetComponent(ComponentName.UnityEngine_UI_Text)
	--- @type UnityEngine_UI_Text
