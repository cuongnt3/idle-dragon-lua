--- @class UIEventGoldenTimeLayoutConfig
UIEventGoldenTimeLayoutConfig = Class(UIEventGoldenTimeLayoutConfig)

--- @return void
--- @param transform UnityEngine_Transform
function UIEventGoldenTimeLayoutConfig:Ctor(transform)
