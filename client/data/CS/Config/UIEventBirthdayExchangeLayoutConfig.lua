--- @class UIEventBirthdayExchangeLayoutConfig
UIEventBirthdayExchangeLayoutConfig = Class(UIEventBirthdayExchangeLayoutConfig)

--- @return void
--- @param transform UnityEngine_Transform
function UIEventBirthdayExchangeLayoutConfig:Ctor(transform)
	...
	self.iconEventTime = self.transform:Find("banner/icon_event_time_24_4"):GetComponent(ComponentName.UnityEngine_UI_Image)
end
