--- @class UIEventNewHeroSummonLayoutConfig
UIEventNewHeroSummonLayoutConfig = Class(UIEventNewHeroSummonLayoutConfig)

--- @return void
--- @param transform UnityEngine_Transform
function UIEventNewHeroSummonLayoutConfig:Ctor(transform)
