--- @class UIEventHalloweenConfig
UIEventHalloweenConfig = Class(UIEventHalloweenConfig)

--- @return void
--- @param transform UnityEngine_Transform
function UIEventHalloweenConfig:Ctor(transform)
	...
	self.loginEventAnchor = self.transform:Find("dice_anchor"):GetComponent(ComponentName.UnityEngine_RectTransform)
	...
	--- @type UnityEngine_RectTransform
	self.diceAnchor = self.transform:Find("dice_anchor"):GetComponent(ComponentName.UnityEngine_RectTransform)
	--- @type UnityEngine_RectTransform
	self.exchangeAnchor = self.transform:Find("exchange_anchor"):GetComponent(ComponentName.UnityEngine_RectTransform)
	--- @type UnityEngine_RectTransform
	self.specialAnchor = self.transform:Find("special_anchor"):GetComponent(ComponentName.UnityEngine_RectTransform)
	--- @type UnityEngine_RectTransform
