--- @class UIEventNewHeroCollectionLayoutConfig
UIEventNewHeroCollectionLayoutConfig = Class(UIEventNewHeroCollectionLayoutConfig)

--- @return void
--- @param transform UnityEngine_Transform
function UIEventNewHeroCollectionLayoutConfig:Ctor(transform)
