--- @class ItemShowWithNameAndTypeConfig
ItemShowWithNameAndTypeConfig = Class(ItemShowWithNameAndTypeConfig)

--- @return void
--- @param transform UnityEngine_Transform
function ItemShowWithNameAndTypeConfig:Ctor(transform)
