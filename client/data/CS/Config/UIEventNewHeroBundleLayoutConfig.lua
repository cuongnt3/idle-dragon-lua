--- @class UIEventNewHeroBundleLayoutConfig
UIEventNewHeroBundleLayoutConfig = Class(UIEventNewHeroBundleLayoutConfig)

--- @return void
--- @param transform UnityEngine_Transform
function UIEventNewHeroBundleLayoutConfig:Ctor(transform)
	...
	--- @type UnityEngine_UI_Text
	self.textTimer = self.transform:Find("bg_tittle/text_timer"):GetComponent(ComponentName.UnityEngine_UI_Text)
