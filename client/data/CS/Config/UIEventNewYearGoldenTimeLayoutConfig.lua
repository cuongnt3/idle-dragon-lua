--- @class UIEventNewYearGoldenTimeLayoutConfig
UIEventNewYearGoldenTimeLayoutConfig = Class(UIEventNewYearGoldenTimeLayoutConfig)

--- @return void
--- @param transform UnityEngine_Transform
function UIEventNewYearGoldenTimeLayoutConfig:Ctor(transform)
	...
	--- @type UnityEngine_UI_Text
	self.textGo = self.transform:Find("button_go/text_go"):GetComponent(ComponentName.UnityEngine_UI_Text)
end
