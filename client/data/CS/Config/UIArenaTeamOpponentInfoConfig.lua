--- @class UIArenaTeamOpponentInfoConfig
UIArenaTeamOpponentInfoConfig = Class(UIArenaTeamOpponentInfoConfig)

--- @return void
--- @param transform UnityEngine_Transform
function UIArenaTeamOpponentInfoConfig:Ctor(transform)
	...
	self.teamInfo = self.transform:Find("popup/team"):GetComponent(ComponentName.UnityEngine_RectTransform)
	--- @type UnityEngine_UI_Button
	...
	--- @type UnityEngine_RectTransform
	self.textAp = self.transform:Find("popup/ap"):GetComponent(ComponentName.UnityEngine_RectTransform)
	--- @type UnityEngine_RectTransform
	...
	--- @type UnityEngine_UI_Text
	self.textApValue = self.transform:Find("popup/text_ap_value"):GetComponent(ComponentName.UnityEngine_UI_Text)
end
