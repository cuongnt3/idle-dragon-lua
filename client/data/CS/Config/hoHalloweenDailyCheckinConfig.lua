--- @class hoHalloweenDailyCheckinConfig
hoHalloweenDailyCheckinConfig = Class(hoHalloweenDailyCheckinConfig)

--- @return void
--- @param transform UnityEngine_Transform
function hoHalloweenDailyCheckinConfig:Ctor(transform)
