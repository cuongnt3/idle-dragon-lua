--- @class UIGuildBossSeasonRewardConfig
UIGuildBossSeasonRewardConfig = Class(UIGuildBossSeasonRewardConfig)

--- @return void
--- @param transform UnityEngine_Transform
function UIGuildBossSeasonRewardConfig:Ctor(transform)
