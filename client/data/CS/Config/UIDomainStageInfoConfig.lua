--- @class UIDomainStageInfoConfig
UIDomainStageInfoConfig = Class(UIDomainStageInfoConfig)

--- @return void
--- @param transform UnityEngine_Transform
function UIDomainStageInfoConfig:Ctor(transform)
	...
	self.buttonRecord = self.transform:Find("popup/buttons/button_record"):GetComponent(ComponentName.UnityEngine_UI_Button)
	--- @type UnityEngine_UI_Button
	self.buttonBattle = self.transform:Find("popup/buttons/button_battle"):GetComponent(ComponentName.UnityEngine_UI_Button)
	--- @type UnityEngine_UI_Text
	self.textRecord = self.transform:Find("popup/buttons/button_record/text_record"):GetComponent(ComponentName.UnityEngine_UI_Text)
	--- @type UnityEngine_UI_Text
	self.textBattle = self.transform:Find("popup/buttons/button_battle/text_battle"):GetComponent(ComponentName.UnityEngine_UI_Text)
	--- @type UnityEngine_UI_Text
