--- @class UIEliteSummonPickWishConfig
UIEliteSummonPickWishConfig = Class(UIEliteSummonPickWishConfig)

--- @return void
--- @param transform UnityEngine_Transform
function UIEliteSummonPickWishConfig:Ctor(transform)
	...
	self.scroll = self.transform:Find("popup/hero_list/scroll"):GetComponent(ComponentName.UnityEngine_UI_LoopVerticalScrollRect)
