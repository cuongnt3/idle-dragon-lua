--- @class UIVictoryArenaLayoutConfig
UIVictoryArenaLayoutConfig = Class(UIVictoryArenaLayoutConfig)

--- @return void
--- @param transform UnityEngine_Transform
function UIVictoryArenaLayoutConfig:Ctor(transform)
	...
	--- @type UnityEngine_GameObject
	self.txtRewardContainer = self.transform:Find("txt_reward").gameObject
end
