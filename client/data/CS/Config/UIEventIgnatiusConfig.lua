--- @class UIEventIgnatiusConfig
UIEventIgnatiusConfig = Class(UIEventIgnatiusConfig)

--- @return void
--- @param transform UnityEngine_Transform
function UIEventIgnatiusConfig:Ctor(transform)
	...
	--- @type UnityEngine_UI_Text
	self.textTicket = self.transform:Find("text_ticket"):GetComponent(ComponentName.UnityEngine_UI_Text)
	--- @type UnityEngine_UI_Text
