--- @class UISpecialOfferMidAutumnItemConfig
UISpecialOfferMidAutumnItemConfig = Class(UISpecialOfferMidAutumnItemConfig)

--- @return void
--- @param transform UnityEngine_Transform
function UISpecialOfferMidAutumnItemConfig:Ctor(transform)
	...
	--- @type UnityEngine_GameObject
	self.tittle = self.transform:Find("icon/rewards_daily/tittle").gameObject
	--- @type UnityEngine_UI_Text
	self.vipText = self.transform:Find("icon/vip_point_view/Text"):GetComponent(ComponentName.UnityEngine_UI_Text)
end
