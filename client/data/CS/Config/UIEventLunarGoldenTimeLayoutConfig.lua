--- @class UIEventLunarGoldenTimeLayoutConfig
UIEventLunarGoldenTimeLayoutConfig = Class(UIEventLunarGoldenTimeLayoutConfig)

--- @return void
--- @param transform UnityEngine_Transform
function UIEventLunarGoldenTimeLayoutConfig:Ctor(transform)
