--- @class UIIapArenaPassMilestoneItemConfig
UIIapArenaPassMilestoneItemConfig = Class(UIIapArenaPassMilestoneItemConfig)

--- @return void
--- @param transform UnityEngine_Transform
function UIIapArenaPassMilestoneItemConfig:Ctor(transform)
	...
	--- @type UnityEngine_GameObject
	self.dotOn = self.transform:Find("bg_dot/dot_on").gameObject
	--- @type UnityEngine_UI_Text
	self.textMilestone = self.transform:Find("bg_dot/text_milestone"):GetComponent(ComponentName.UnityEngine_UI_Text)
	--- @type UnityEngine_GameObject
	self.bgProgressRight = self.transform:Find("bg_progress_right").gameObject
	--- @type UnityEngine_GameObject
	self.bgProgressLeft = self.transform:Find("bg_progress_left").gameObject
	--- @type UnityEngine_GameObject
	self.activeProgressRight = self.transform:Find("bg_progress_right/active_progress_right").gameObject
	--- @type UnityEngine_GameObject
	self.activeProgressLeft = self.transform:Find("bg_progress_left/active_progress_left").gameObject
end
