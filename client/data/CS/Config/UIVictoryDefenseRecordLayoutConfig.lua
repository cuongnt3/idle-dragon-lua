--- @class UIVictoryDefenseRecordLayoutConfig
UIVictoryDefenseRecordLayoutConfig = Class(UIVictoryDefenseRecordLayoutConfig)

--- @return void
--- @param transform UnityEngine_Transform
function UIVictoryDefenseRecordLayoutConfig:Ctor(transform)
