--- @class DefenseTownCenterSpotConfig
DefenseTownCenterSpotConfig = Class(DefenseTownCenterSpotConfig)

--- @return void
--- @param transform UnityEngine_Transform
function DefenseTownCenterSpotConfig:Ctor(transform)
	...
	--- @type UnityEngine_Transform
	self.defenseBuildingAnim = self.transform:Find("defense_town_center_1")
end
