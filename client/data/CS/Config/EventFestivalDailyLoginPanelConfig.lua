--- @class EventFestivalDailyLoginPanelConfig
EventFestivalDailyLoginPanelConfig = Class(EventFestivalDailyLoginPanelConfig)

--- @return void
--- @param transform UnityEngine_Transform
function EventFestivalDailyLoginPanelConfig:Ctor(transform)
