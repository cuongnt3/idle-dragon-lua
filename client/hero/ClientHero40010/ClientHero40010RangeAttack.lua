--- @class ClientHero40010RangeAttack : BaseRangeAttack
ClientHero40010RangeAttack = Class(ClientHero40010RangeAttack, BaseRangeAttack)

function ClientHero40010RangeAttack:DeliverCtor()
    --- @type ClientEffect
    self.projectile = nil
    self.projectileLaunchPos = self.clientHero.components:FindChildByPath("Model/launch_position").position
end

function ClientHero40010RangeAttack:OnCastEffect()
...
function ClientHero40010RangeAttack:GetProjectile(effectType, effectName)
...
function ClientHero40010RangeAttack:BreakSkillAction()
    BaseRangeAttack.BreakSkillAction(self)
    self:ReleaseProjectile(true)
end

--- @param killAction boolean
function ClientHero40010RangeAttack:ReleaseProjectile(killAction)
