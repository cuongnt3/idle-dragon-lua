--- @class Summoner1_Skill1_1_Data Mage
Summoner1_Skill1_1_Data = Class(Summoner1_Skill1_1_Data, BaseSkillData)

---------------------------------------- Initialization ----------------------------------------
--- @return BaseSkillData
function Summoner1_Skill1_1_Data:CreateInstance()
    return Summoner1_Skill1_1_Data()
end

--- @return void
--- @param parsedData table
function Summoner1_Skill1_1_Data:ValidateBeforeParseCsv(parsedData)
...
--- @return void
--- @param parsedData table
function Summoner1_Skill1_1_Data:ParseCsv(parsedData)
