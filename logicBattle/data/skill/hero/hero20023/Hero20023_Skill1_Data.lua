--- @class Hero20023_Skill1_Data Kaboom
Hero20023_Skill1_Data = Class(Hero20023_Skill1_Data, BaseSkillData)

---------------------------------------- Initialization ----------------------------------------
--- @return BaseSkill
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero20023_Skill1_Data:CreateInstance(id, hero)
    return Hero20023_Skill1_Data(id, hero)
end

--- @return void
--- @param parsedData table
function Hero20023_Skill1_Data:ValidateBeforeParseCsv(parsedData)
...
--- @return void
--- @param parsedData table
function Hero20023_Skill1_Data:ParseCsv(parsedData)
