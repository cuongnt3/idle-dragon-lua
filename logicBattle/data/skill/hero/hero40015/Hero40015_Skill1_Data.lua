--- @class Hero40015_Skill1_Data Berko
Hero40015_Skill1_Data = Class(Hero40015_Skill1_Data, BaseSkillData)

---------------------------------------- Initialization ----------------------------------------
--- @return BaseSkill
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero40015_Skill1_Data:CreateInstance(id, hero)
    return Hero40015_Skill1_Data(id, hero)
end

--- @return void
--- @param parsedData table
function Hero40015_Skill1_Data:ValidateBeforeParseCsv(parsedData)
...
--- @return void
--- @param parsedData table
function Hero40015_Skill1_Data:ParseCsv(parsedData)
