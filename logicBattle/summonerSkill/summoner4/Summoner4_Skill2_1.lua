--- @class Summoner4_Skill2_1 Assassin
Summoner4_Skill2_1 = Class(Summoner4_Skill2_1, BaseSkill)

---------------------------------------- Initialization ----------------------------------------
--- @return BaseSkill
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Summoner4_Skill2_1:CreateInstance(id, hero)
    return Summoner4_Skill2_1(id, hero)
end

--- @return void
function Summoner4_Skill2_1:Init()
