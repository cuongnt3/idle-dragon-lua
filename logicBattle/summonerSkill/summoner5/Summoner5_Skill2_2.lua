--- @class Summoner5_Skill2_2 Ranger
Summoner5_Skill2_2 = Class(Summoner5_Skill2_2, BaseSkill)

---------------------------------------- Initialization ----------------------------------------
--- @return BaseSkill
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Summoner5_Skill2_2:CreateInstance(id, hero)
    return Summoner5_Skill2_2(id, hero)
end

--- @return void
function Summoner5_Skill2_2:Init()
