--- @class Summoner5_Skill2_1 Ranger
Summoner5_Skill2_1 = Class(Summoner5_Skill2_1, BaseSkill)

---------------------------------------- Initialization ----------------------------------------
--- @return BaseSkill
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Summoner5_Skill2_1:CreateInstance(id, hero)
    return Summoner5_Skill2_1(id, hero)
end

--- @return void
function Summoner5_Skill2_1:Init()
