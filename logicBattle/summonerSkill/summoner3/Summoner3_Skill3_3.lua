--- @class Summoner3_Skill3_3 Priest
Summoner3_Skill3_3 = Class(Summoner3_Skill3_3, BaseSkill)

---------------------------------------- Initialization ----------------------------------------
--- @return BaseSkill
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Summoner3_Skill3_3:CreateInstance(id, hero)
    return Summoner3_Skill3_3(id, hero)
end

--- @return void
function Summoner3_Skill3_3:Init()
