--- @class Hero30013_Skill1 Minimanser
Hero30013_Skill1 = Class(Hero30013_Skill1, BaseSkill)

--- @return void
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero30013_Skill1:Ctor(id, hero)
...
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero30013_Skill1:CreateInstance(id, hero)
    return Hero30013_Skill1(id, hero)
end

--- @return void
function Hero30013_Skill1:Init()
...
function Hero30013_Skill1:UseActiveSkill()
