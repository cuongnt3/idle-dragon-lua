--- @class Hero40022_Skill4 Arawen
Hero40022_Skill4 = Class(Hero40022_Skill4, BaseSkill)

---------------------------------------- Initialization ----------------------------------------
--- @return BaseSkill
--- @param id number
--- @param hero BaseHero
function Hero40022_Skill4:CreateInstance(id, hero)
    return Hero40022_Skill4(id, hero)
end

--- @return void
function Hero40022_Skill4:Init()
...
function Hero40022_Skill4:OnDealDamageToEnemy(enemyDefender, totalDamage, dodgeType)
