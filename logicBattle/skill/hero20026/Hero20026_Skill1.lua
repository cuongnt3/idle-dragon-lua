--- @class Hero20026_Skill1 Kardoh
Hero20026_Skill1 = Class(Hero20026_Skill1, BaseSkill)

--- @return void
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero20026_Skill1:Ctor(id, hero)
...
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero20026_Skill1:CreateInstance(id, hero)
    return Hero20026_Skill1(id, hero)
end

--- @return void
function Hero20026_Skill1:Init()
...
function Hero20026_Skill1:UseActiveSkill()
