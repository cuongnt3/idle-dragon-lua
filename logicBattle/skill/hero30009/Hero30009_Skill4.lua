--- @class Hero30009_Skill4 Gorzodin
Hero30009_Skill4 = Class(Hero30009_Skill4, BaseSkill)

---------------------------------------- Initialization ----------------------------------------
--- @return BaseSkill
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero30009_Skill4:CreateInstance(id, hero)
    return Hero30009_Skill4(id, hero)
end

--- @return void
function Hero30009_Skill4:Init()
