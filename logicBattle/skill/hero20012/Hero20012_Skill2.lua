--- @class Hero20012_Skill2 Sharon
Hero20012_Skill2 = Class(Hero20012_Skill2, BaseSkill)

--- @return void
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero20012_Skill2:Ctor(id, hero)
...
--- @param id number
--- @param hero BaseHero
function Hero20012_Skill2:CreateInstance(id, hero)
    return Hero20012_Skill2(id, hero)
end

--- @return void
function Hero20012_Skill2:Init()
...
function Hero20012_Skill2:OnTakeDamageFromEnemy(enemyAttacker, totalDamage)
...
--- @param totalDamage number
function Hero20012_Skill2:OnTakeSkillDamageFromEnemy(enemy, totalDamage)
    if totalDamage > 0 then
...
--- @return void
--- @param enemyAttacker BaseHero
function Hero20012_Skill2:InflictEffect(enemyAttacker)
