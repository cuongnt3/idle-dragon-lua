--- @class Hero40020_Skill1 Athelas
Hero40020_Skill1 = Class(Hero40020_Skill1, BaseSkill)

--- @return void
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero40020_Skill1:Ctor(id, hero)
...
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero40020_Skill1:CreateInstance(id, hero)
    return Hero40020_Skill1(id, hero)
end

--- @return void
function Hero40020_Skill1:Init()
...
function Hero40020_Skill1:UseActiveSkill()
