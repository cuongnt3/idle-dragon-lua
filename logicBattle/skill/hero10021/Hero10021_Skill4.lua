--- @class Hero10021_Skill4 AquaKnight
Hero10021_Skill4 = Class(Hero10021_Skill4, BaseSkill)

--- @return void
--- @param id number
--- @param hero BaseHero
function Hero10021_Skill4:Ctor(id, hero)
...
--- @param id number
--- @param hero BaseHero
function Hero10021_Skill4:CreateInstance(id, hero)
    return Hero10021_Skill4(id, hero)
end

--- @return void
function Hero10021_Skill4:Init()
...
function Hero10021_Skill4:OnHpChange(eventData)
...
--- @return void
function Hero10021_Skill4:BuffStat()
