--- @class Hero50024_Skill1 Dwarf
Hero50024_Skill1 = Class(Hero50024_Skill1, BaseSkill)

--- @return void
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero50024_Skill1:Ctor(id, hero)
...
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero50024_Skill1:CreateInstance(id, hero)
    return Hero50024_Skill1(id, hero)
end

--- @return void
function Hero50024_Skill1:Init()
...
function Hero50024_Skill1:UseActiveSkill()
...
function Hero50024_Skill1:InflictEffect(target)
