--- @class Hero30010_Skill1 Erde
Hero30010_Skill1 = Class(Hero30010_Skill1, BaseSkill)

--- @return void
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero30010_Skill1:Ctor(id, hero)
...
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero30010_Skill1:CreateInstance(id, hero)
    return Hero30010_Skill1(id, hero)
end

--- @return void
function Hero30010_Skill1:Init()
    ...
    self.healSkillHelper:SetActionPerTarget(self.OnHeal)
...
function Hero30010_Skill1:BindingWithSkill_2(skill)
    self.skill_2 = skill
end

--- @return List<BaseActionResult>, boolean turn of this hero should be ended or not
function Hero30010_Skill1:UseActiveSkill()
...
function Hero30010_Skill1:OnHeal(target)
    if self.skill_2 ~= nil then
        self.skill_2:OnHeal(target)
    end
end

return Hero30010_Skill1