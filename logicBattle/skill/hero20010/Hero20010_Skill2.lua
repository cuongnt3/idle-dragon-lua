--- @class Hero20010_Skill2 Ungoliant
Hero20010_Skill2 = Class(Hero20010_Skill2, BaseSkill)

--- @return void
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero20010_Skill2:Ctor(id, hero)
...
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero20010_Skill2:CreateInstance(id, hero)
    return Hero20010_Skill2(id, hero)
end

--- @return void
function Hero20010_Skill2:Init()
...
function Hero20010_Skill2:OnEndBattleTurn(turn)
