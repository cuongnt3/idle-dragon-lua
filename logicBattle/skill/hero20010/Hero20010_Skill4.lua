--- @class Hero20010_Skill4 Ungoliant
Hero20010_Skill4 = Class(Hero20010_Skill4, BaseSkill)

--- @return void
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero20010_Skill4:Ctor(id, hero)
...
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero20010_Skill4:CreateInstance(id, hero)
    return Hero20010_Skill4(id, hero)
end

--- @return void
function Hero20010_Skill4:Init()
...
function Hero20010_Skill4:OnTakeDamageFromEnemy(enemyAttacker, totalDamage)
...
--- @param totalDamage number
function Hero20010_Skill4:OnTakeSkillDamageFromEnemy(enemy, totalDamage)
    self:InflictEffect(enemy)
end

--- @return void
function Hero20010_Skill4:InflictEffect()
