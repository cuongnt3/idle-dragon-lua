--- @class Hero40004_Skill2 Cennunos
Hero40004_Skill2 = Class(Hero40004_Skill2, BaseSkill)

--- @return void
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero40004_Skill2:Ctor(id, hero)
...
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero40004_Skill2:CreateInstance(id, hero)
    return Hero40004_Skill2(id, hero)

end

--- @return void
function Hero40004_Skill2:Init()
...
function Hero40004_Skill2:OnDealDamageToEnemy(enemyDefender, totalDamage, dodgeType)
    --- check can heal
...
function Hero40004_Skill2:Dead(initiator, reason)
    self.wasAdded = false
end

return Hero40004_Skill2