--- @class Hero20004_Skill1 Defronowe
Hero20004_Skill1 = Class(Hero20004_Skill1, BaseSkill)

--- @return BaseSkill
function Hero20004_Skill1:Ctor(id, hero)
...
--- @param hero BaseHero
function Hero20004_Skill1:CreateInstance(id, hero)
    return Hero20004_Skill1(id, hero)
end

--- @return void
function Hero20004_Skill1:Init()
...
function Hero20004_Skill1:UseActiveSkill()
...
function Hero20004_Skill1:InflictEffect(target)
