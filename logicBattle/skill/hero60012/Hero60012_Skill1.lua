--- @class Hero60012_Skill1 Juan
Hero60012_Skill1 = Class(Hero60012_Skill1, BaseSkill)

--- @return void
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero60012_Skill1:Ctor(id, hero)
...
--- @param id number id of skill (1: activeSkill, 2-4: passiveSkills)
--- @param hero BaseHero
function Hero60012_Skill1:CreateInstance(id, hero)
    return Hero60012_Skill1(id, hero)
end

--- @return void
function Hero60012_Skill1:Init()
    ...
    self.damageSkillHelper:SetBonusSkillDamage(self.effectTriggerClass, self.bonusDamageWithClass)
...
function Hero60012_Skill1:UseActiveSkill()
...
function Hero60012_Skill1:InflictEffect(target)
