--- @class Hero30019_BattleHelper
Hero30019_BattleHelper = Class(Hero30019_BattleHelper, BattleHelper)

--- @return void
--- @param hero BaseHero
function Hero30019_BattleHelper:Ctor(hero)
...
function Hero30019_BattleHelper:BindingWithSkill_2(skill)
    self.skill_2 = skill
end

--- @return number, boolean, DodgeType, boolean totalDamage, isCrit, dodgeType, isBlock
--- @param target BaseHero
function Hero30019_BattleHelper:CalculateAttackResult(target)
...
function Hero30019_BattleHelper:CalculateActiveSkillResult(target, damageMultiplier)
